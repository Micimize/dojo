...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__4067__auto__,writer__4068__auto__,opt__4069__auto__){return cljs.core._write.call(null,writer__4068__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_12483 = 0;while(true){
if((i_12483 < arr.length))
{(arr[i_12483] = null);
{
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__4067__auto__,writer__4068__auto__,opt__4069__auto__){return cljs.core._write.call(null,writer__4068__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_12490 = (self__.level + 1);while(true){
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_12492 = 0;while(true){
if((i_12492 <= self__.level))
{var links_12493 = (update[i_12492]).forward;if(((links_12493[i_12492]) === x__$1))
{(links_12493[i_12492] = (x__$1.forward[i_12492]));
{
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__3500__auto__ = (cljs.core.truth_((function (){var and__3488__auto__ = me;if(cljs.core.truth_(and__3488__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__3488__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__3500__auto__))
