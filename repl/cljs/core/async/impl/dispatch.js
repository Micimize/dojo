...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_12518 = 0;while(true){
var m_12519 = cljs.core.async.impl.dispatch.tasks.pop();if((m_12519 == null))
{} else
{m_12519.call(null);
if((count_12518 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__12520 = (count_12518 + 1);
count_12518 = G__12520;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__3488__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__3488__auto__)
