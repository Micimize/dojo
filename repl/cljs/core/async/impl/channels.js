...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t12524 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t12524 = (function (val,box,meta12525){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t12524.cljs$lang$type = true;
cljs.core.async.impl.channels.t12524.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t12524";
cljs.core.async.impl.channels.t12524.cljs$lang$ctorPrWriter = (function (this__4067__auto__,writer__4068__auto__,opt__4069__auto__){return cljs.core._write.call(null,writer__4068__auto__,"cljs.core.async.impl.channels/t12524");
});
cljs.core.async.impl.channels.t12524.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t12524.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_12526){var self__ = this;
var _12526__$1 = this;return self__.meta12525;
});
cljs.core.async.impl.channels.t12524.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_12526,meta12525__$1){var self__ = this;
var _12526__$1 = this;return (new cljs.core.async.impl.channels.t12524(self__.val,self__.box,meta12525__$1));
});
cljs.core.async.impl.channels.__GT_t12524 = (function __GT_t12524(val__$1,box__$1,meta12525){return (new cljs.core.async.impl.channels.t12524(val__$1,box__$1,meta12525));
});
}
return (new cljs.core.async.impl.channels.t12524(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__4070__auto__,writer__4071__auto__,opts__4072__auto__){return cljs.core._write.call(null,writer__4071__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__4067__auto__,writer__4068__auto__,opt__4069__auto__){return cljs.core._write.call(null,writer__4068__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_12527 = self__.takes.pop();if((taker_12527 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_12527))
{var take_cb_12528 = cljs.core.async.impl.protocols.commit.call(null,taker_12527);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_12528,taker_12527){
return (function (){return take_cb_12528.call(null,null);
});})(take_cb_12528,taker_12527))
);
} else
{}
{
