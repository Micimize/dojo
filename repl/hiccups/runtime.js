...
hiccups.runtime.in_mode = (function in_mode(mode,f){var _STAR_html_mode_STAR_12586 = hiccups.runtime._STAR_html_mode_STAR_;try{hiccups.runtime._STAR_html_mode_STAR_ = mode;
return f.call(null);
}finally {hiccups.runtime._STAR_html_mode_STAR_ = _STAR_html_mode_STAR_12586;
}});
/**
...
hiccups.runtime.render_attribute = (function render_attribute(p__12587){var vec__12589 = p__12587;var name = cljs.core.nth.call(null,vec__12589,0,null);var value = cljs.core.nth.call(null,vec__12589,1,null);if(value === true)
...
*/
hiccups.runtime.normalize_element = (function normalize_element(p__12590){var vec__12593 = p__12590;var tag = cljs.core.nth.call(null,vec__12593,0,null);var content = cljs.core.nthnext.call(null,vec__12593,1);if(!(((tag instanceof cljs.core.Keyword)) || ((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string')))
{throw [cljs.core.str(tag),cljs.core.str(" is not a valid tag name")].join('');
} else
{}
var vec__12594 = cljs.core.re_matches.call(null,hiccups.runtime.re_tag,hiccups.runtime.as_str.call(null,tag));var _ = cljs.core.nth.call(null,vec__12594,0,null);var tag__$1 = cljs.core.nth.call(null,vec__12594,1,null);var id = cljs.core.nth.call(null,vec__12594,2,null);var class$ = cljs.core.nth.call(null,vec__12594,3,null);var tag_attrs = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"id","id",1013907597),id,new cljs.core.Keyword(null,"class","class",1108647146),(cljs.core.truth_(class$)?clojure.string.replace.call(null,class$,"."," "):null)], null);var map_attrs = cljs.core.first.call(null,content);if(cljs.core.map_QMARK_.call(null,map_attrs))
...
*/
hiccups.runtime.render_element = (function render_element(element){var vec__12596 = hiccups.runtime.normalize_element.call(null,element);var tag = cljs.core.nth.call(null,vec__12596,0,null);var attrs = cljs.core.nth.call(null,vec__12596,1,null);var content = cljs.core.nth.call(null,vec__12596,2,null);if(cljs.core.truth_((function (){var or__3500__auto__ = content;if(cljs.core.truth_(or__3500__auto__))
